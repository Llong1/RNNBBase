...
export var getNBInstantUserList = function (pageNo, pageSize) {
    return NBGateway.getGateway().then(function (v) {
        ...
        .then(function (r) { return r.result && r.result.data ? r.result.data.map(function (c) { return adapterNBCommunicationListModel(c); }) : []; });
};
