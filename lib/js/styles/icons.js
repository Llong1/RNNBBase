...
export var NBIconArrowRight = function (iconProps) {
    var props = Object.assign({ size: 22, color: 'rgba(144, 144, 144, 1)' }, iconProps);
    var comp = <SvgXml xml={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"" + props.size + "\" height=\"" + props.size + "\" style=\"fill: " + props.color + ";\"><path d=\"M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z\"/></svg>"}/>;
    return props.onPress ? <TouchableOpacity onPress={function () {
        if (props.onPress) {
            props.onPress();
        }
...
export var NBIconArrowLeft = function (iconProps) {
    var props = Object.assign({ size: 24, color: 'rgba(255, 255, 255, 1)' }, iconProps);
    var comp = <SvgXml xml={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"" + props.size + "\" height=\"" + props.size + "\" style=\"fill: " + props.color + ";\"><path d=\"M21 11H6.83l3.58-3.59L9 6l-6 6 6 6 1.41-1.41L6.83 13H21z\"/></svg>"}/>;
    return props.onPress ? <TouchableOpacity onPress={function () {
        if (props.onPress) {
            props.onPress();
        }
...
export var NBIconSWap = function (iconProps) {
    var props = Object.assign({ size: 14, color: 'rgba(255, 255, 255, 1)' }, iconProps);
...
export var NBIconCubes = function (iconProps) {
    var props = Object.assign({ size: 18, color: 'rgba(255, 255, 255, 1)' }, iconProps);
...
export var NBIconNotice = function (iconProps) {
    var props = Object.assign({ size: 20, color: 'rgba(236, 101, 110, 1)' }, iconProps);
 ...
 * @param iconProps
 */
export var NBIconList = function (iconProps) {
    var props = Object.assign({ size: 50, color: 'rgba(80, 62, 157, 1)' }, iconProps);
    var comp = <SvgXml xml={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"" + props.size + "\" height=\"" + props.size + "\" style=\"fill: " + props.color + ";\"><path d=\"M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z\"/></svg>"}/>;
    return props.onPress ? <TouchableOpacity onPress={function () {
        if (props.onPress) {
            props.onPress();
        }
 ...
 * @param iconProps
 */
export var NBIconPayAddList = function (iconProps) {
    var props = Object.assign({ size: 40, color: 'rgba(255, 255, 255, 1)' }, iconProps);
    var comp = <SvgXml xml={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"" + props.size + "\" height=\"" + props.size + "\" style=\"fill: " + props.color + ";\"><path d=\"M14 10H2v2h12v-2zm0-4H2v2h12V6zm4 8v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zM2 16h8v-2H2v2z\"/></svg>"}/>;
    return props.onPress ? <TouchableOpacity onPress={function () {
        if (props.onPress) {
            props.onPress();
        }
 ...
 * @param iconProps
 */
export var NBIconPayAddCheckList = function (iconProps) {
    var props = Object.assign({ size: 40, color: 'rgba(255, 255, 255, 1)' }, iconProps);
    var comp = <SvgXml xml={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"" + props.size + "\" height=\"" + props.size + "\" style=\"fill: " + props.color + ";\"><path d=\"M14 10H2v2h12v-2zm0-4H2v2h12V6zM2 16h8v-2H2v2zm19.5-4.5L23 13l-6.99 7-4.51-4.5L13 14l3.01 3 5.49-5.5z\"/></svg>"}/>;
    return props.onPress ? <TouchableOpacity onPress={function () {
        if (props.onPress) {
            props.onPress();
        }
 ...
 * @param iconProps
 */
export var NBIconCheck = function (iconProps) {
    var props = Object.assign({ size: 40, color: 'rgba(255, 255, 255, 1)' }, iconProps);
    var comp = <SvgXml xml={"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" width=\"" + props.size + "\" height=\"" + props.size + "\" style=\"fill: " + props.color + ";\"><path d=\"M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z\"/></svg>"}/>;
    return props.onPress ? <TouchableOpacity onPress={function () {
        if (props.onPress) {
            props.onPress();
        }
...
export var NBIcons = {
    NBIconNotice: NBIconNotice,
    NBIconArrowRight: NBIconArrowRight,
    NBIconList: NBIconList,
    NBIconPayAddList: NBIconPayAddList,
    NBIconPayAddCheckList: NBIconPayAddCheckList,
    NBIconCheck: NBIconCheck,
    NBIconLoading: NBIconLoading
};
