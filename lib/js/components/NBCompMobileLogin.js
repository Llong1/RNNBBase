...
var NBCompMobileLogin = /** @class */ (function (_super) {
    ...
    NBCompMobileLogin.prototype.fetchSMS = function (phone) {
        return NBGateway.getGateway().then(function (v) {
            return createNBNetworkApi('GET').then(function (a) { return a({
    ...
    NBCompMobileLogin.prototype.submit = function () {
        ...
        if (this.state.showRegister) {
            NBGateway.getGateway()
                .then(function (c) {
                return createNBNetworkApi('POST').then(function (a) { return a({
    ...
    NBCompMobileLogin.prototype.render = function () {
        ...
        var comp = null;
        var inputStyle = Platform.OS === 'android' ? { flex: 1, height: 43, lineHeight: 41, margin: 0, padding: 0 } : { flex: 1, margin: 0, padding: 0 };
        if (this.state.showRegister) {
            comp = <View style={{ width: 312, padding: 27, backgroundColor: 'white', borderRadius: 10 }}>
                ...
                <View style={styles.inputViewStyle}>
                    ...
                    <Input style={inputStyle} key="nick_name_input" keyboardType="default" placeholder="请输入您的真实姓名" onChangeText={function (userName) {
                _this.setState({
                ...
                <View style={[styles.inputViewStyle, { marginTop: 20 }]}>
                    ...
                    <Input style={inputStyle} key="reg_phone_input" keyboardType="numeric" value={this.state.registerParams.userPhone} placeholder="请输入手机号码" onChangeText={function (phone) {
                _this.setState({
                ...
                <View style={[styles.inputViewStyle, { marginTop: 20 }]}>
                    ...
                    <Input style={inputStyle} key="reg_code_input" keyboardType="numeric" placeholder="请输入验证码" onChangeText={function (code) {
                _this.setState({
                ...
                <View style={[styles.inputViewStyle, { marginTop: 20, marginBottom: 20 }]}>
                    ...
                    <Input style={inputStyle} secureTextEntry placeholder="请设置您的密码" onChangeText={function (password) {
                _this.setState({
            ...
            comp = <View style={{ width: 312, padding: 27, backgroundColor: 'white', borderRadius: 10 }}>
                ...
                <View style={[styles.inputViewStyle, { marginTop: 20 }]}>
                    <NBIconPhone style={{ marginLeft: 9, marginTop: 9 }}/>
                    <Input style={inputStyle} key="phone_input" keyboardType="numeric" value={this.state.loginParams.phone} placeholder="请输入手机号码" onChangeText={function (phone) {
                _this.setState({
                ...
                {this.state.bySms ? <View style={[styles.inputViewStyle, { marginTop: 20 }]}>
                        <NBIconSafeCode style={{ marginLeft: 9, marginTop: 9 }}/>
                        <Input style={inputStyle} key="login_code_input" keyboardType="numeric" placeholder="请输入验证码" onChangeText={function (code) {
                _this.setState({
                ...
                return false;
                            ...
                            <NBIconLock style={{ marginLeft: 9, marginTop: 9 }}/>
                            <Input style={inputStyle} secureTextEntry onChangeText={function (password) {
                _this.setState({
