...
var NBPageInstantDetail = /** @class */ (function (_super) {
    ...
    NBPageInstantDetail.prototype.componentDidMount = function () {
        var _this_1 = this;
        var instantClient = this.props.route.params.instantClient || NBCompApp.instantConfig.instantClient;
    ...
    NBPageInstantDetail.prototype.render = function () {
        ...
        return <Container style={{ backgroundColor: backgroundColor }}>
            ...
            var comp = NBCompApp.instantConfig.msgDetailRender ? NBCompApp.instantConfig.msgDetailRender(item, index) : null;
            if (comp) {
                return comp;
            }
